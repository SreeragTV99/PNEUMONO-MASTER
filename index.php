                     ...
                     <div class="navbar-area">
                        <nav class="site-navbar">
                           <ul>
                              ...
                              <li><a href="ulog.php">SignIn</a></li>
                           </ul>
         ...
         <div class="container_width">
            <div class="row d_flex">
                  ...
                  <div class="titlepage text_align_left">
                     ...
                     <p>Pneumonia is a lung infection that can range from mild to so severe that you have to go to the hospital.But we provide an opportunity to detect pneumonia without consulting doctor.
                     </p>
               ...
               <div class="col-md-5">
                  <div class="about_img text_align_center">
                     <figure><img src="images/lung1.png" alt="#"/></figure>
                  </div>
               </div>
