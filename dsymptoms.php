            ...
            <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-9">
                ...
                <nav class="site-navbar">
                    <ul>
                        ...
                        <li><a class="active" href="dsymptoms.php">Symptoms</a></li>
         ...
         <div class="container_width">
            <div class="row d_flex">
                  ...
                  <div class="titlepage text_align_left">
                     <h2>SYMPTOMS</h2>
                     <p>Pneumonia symptoms can be mild to life-threatening. They can include</p>
               ...
               <div class="col-md-5">
                  <div class="about_img text_align_center">
                     <figure><img src="images/lung.jpg" alt="#"/></figure>
                  </div>
               </div>
