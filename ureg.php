   ...
   <body class="main-layout inner_page">
     ...
     <div class="contact">
         <div class="container">
            ...
            <div class="row">
               <div class="col-md-6">
                  <form id="request" name="RegForm" onsubmit="return formValidation() " action="uregaction.php" method="POST" class="main_form"  enctype="multipart/form-data">
                     <div class="row">
                        <div class="col-md-12 ">
                        ...
                        <div class="col-md-12">
                           <input class="contactus" placeholder="DOB" type="date" name="DOB" id="DOB" value="DOB"> 
                        </div>
